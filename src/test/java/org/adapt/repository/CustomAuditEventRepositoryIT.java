...
import org.adapt.config.audit.AuditEventConverter;
import org.adapt.domain.PersistentAuditEvent;
...
import static org.adapt.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
